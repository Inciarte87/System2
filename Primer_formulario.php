...
<div align="right"><a href="Menu.php"> <input type="button" value="&nbsp;Atras&nbsp;" name="bot_button" id="boton_cerrar"></a> <?php echo $_SESSION['usuario'];?> <a href="cerrar.php"> <input type="submit" name="cerrar sesion" value="Cerrar sesion" id="boton_cerrar"> </a></div>
...
<body background="Img/Logo_escuela.jpg" class="Body_Primer_Formulario">
    ...
    <fieldset id="fiel_ses">   
		...
		<form method="post" action="Guardar.php" name="PrimerFormulario">
